...
position_min = -10  # position minimale de l'espace de recherche
position_max = 10  # position maximale de l'espace de recherche
cmax = 0.7  # coefficient de contrition
tau = 1.74  # coefficient d'inertie
v_max = 2  # Vitesse maximale
v_min = -2  # Vitesse minimale
spacewidth = 1  # l'espace de recherche
fichier_gif = './pso_spheref.gif'  # le fichier gif de visualisation
...
class PSO:
    ...
    def OEP(self):
        ...
        # affichage de l'evolution de l'optimum global
